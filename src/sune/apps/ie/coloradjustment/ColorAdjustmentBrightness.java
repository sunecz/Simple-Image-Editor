...
public class ColorAdjustmentBrightness extends PluginWindow
{
	private double min;
	private double max;
	private double val;
	...
	public ColorAdjustmentBrightness(Editor editor)
	{
		super("colorAdjustments.brightness", editor, 250, 120);
