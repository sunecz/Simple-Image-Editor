...
public class ColorAdjustmentContrast extends PluginWindow
{
	private double min;
	private double max;
	private double val;
	...
	public ColorAdjustmentContrast(Editor editor)
	{
		super("colorAdjustments.contrast", editor, 250, 120);
