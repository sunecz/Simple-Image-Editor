...
public class ColorAdjustmentGammaCorrection extends PluginWindow
{
	private double min;
	private double max;
	private double val;
	...
	public ColorAdjustmentGammaCorrection(Editor editor)
	{
		super("colorAdjustments.gammaCorrection", editor, 250, 120);
