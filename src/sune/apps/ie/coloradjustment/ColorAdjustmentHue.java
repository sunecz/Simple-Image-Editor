...
public class ColorAdjustmentHue extends PluginWindow
{
	private double min;
	private double max;
	private double val;
	...
	public ColorAdjustmentHue(Editor editor)
	{
		super("colorAdjustments.hue", editor, 250, 120);
	...
	{
		image.setHue((float) ((val + 100) / 100));
	}
}