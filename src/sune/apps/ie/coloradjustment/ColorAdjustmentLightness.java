...
public class ColorAdjustmentLightness extends PluginWindow
{
	private double min;
	private double max;
	private double val;
	...
	public ColorAdjustmentLightness(Editor editor)
	{
		super("colorAdjustments.lightness", editor, 250, 120);
	...
	{
		image.setLightness((float) ((val + 100) / 100));
	}
}