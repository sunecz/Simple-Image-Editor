...
public class ColorAdjustmentTransparency extends PluginWindow
{
	private double min;
	private double max;
	private double val;
	...
	public ColorAdjustmentTransparency(Editor editor)
	{
		super("colorAdjustments.transparency", editor, 250, 120);
