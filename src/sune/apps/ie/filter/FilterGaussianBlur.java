...
public class FilterGaussianBlur extends PluginWindow
{
	private double min;
	private double max;
	private double val;
	...
	public FilterGaussianBlur(Editor editor)
	{
		super("filters.gaussianBlur", editor, 250, 120);
	...
	{
		image.filters.gaussianBlur((int) val);
	}
}